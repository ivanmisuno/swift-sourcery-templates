...
that can be used as test doubles in place of object dependencies for unit-testing.
                       DESC
  s.homepage         = 'https://github.com/albumprinter/swift-sourcery-templates'
  s.license          = { :type => 'Apache License, Version 2.0', :file => 'LICENSE.txt' }
  s.author           = { 'Ivan Misuno' => 'i.misuno@gmail.com' }

  s.dependency 'Sourcery', '~> 0.15.0'

  s.source           = { :http => "https://github.com/albumprinter/swift-sourcery-templates/releases/download/#{s.version}/swift-sourcery-templates-#{s.version}.zip" }
  s.preserve_paths   = '*'
  s.exclude_files    = '**/*.zip'
